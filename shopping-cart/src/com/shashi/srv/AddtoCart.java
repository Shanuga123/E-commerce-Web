...
public class AddtoCart extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        if (pQty == cartQty) {
            ...
            pw.println("<script>document.getElementById('message').innerHTML='" + escapeJavaScript(status) + "'</script>");
            ...
            if (availableQty == 0) {
                ...
                status = "Only " + availableQty + " no of " + escapeJavaScript(product.getProdName())
            ...
            if (flag)
                status += "<br/>Later, We Will Mail You when " + escapeJavaScript(product.getProdName())
